...
public class Color implements Comparable<Color>{
	...
	/**
	 * Overriden method that compares the hexValue and colorName of two Color objects
	 * 
	...
	public int compareTo(Color o) {
		String thisToCompare = this.getHexValue()+this.getName();
		String toCompare = o.getHexValue()+o.getName();
		return thisToCompare.compareToIgnoreCase(toCompare);
	}
